...
const competitor = getCompetitorById('sqldbm')!;

export const metadata: Metadata = {
  title: 'SqlDBM vs SchemaVis: Honest Comparison for Database Visualization',
  description:
    'Compare SqlDBM and SchemaVis (alpha) for database visualization. SqlDBM is enterprise-ready with excellent visuals, while SchemaVis is open source and collaborative.',
  openGraph: {
    title: 'SqlDBM vs SchemaVis: Honest Comparison',
    description:
      'Compare SqlDBM and SchemaVis for database visualization.',
    type: 'website',
    url: 'https://schemavis.gossorg.in/sqldbm-vs-schemavis',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'SqlDBM vs SchemaVis: Honest Comparison',
    description: 'Compare SqlDBM and SchemaVis for database visualization.',
  },
};

export default function SqlDBMComparisonPage() {
  return (
        ...
        <div className="space-y-12">
          ...
          <header className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold">
                  SqlDBM vs SchemaVis: Honest Comparison
                </h1>
            ...
            <p className="text-lg text-slate-300">
              SqlDBM is a professional database modeling tool with excellent
              visualization capabilities, designed for enterprise use. SchemaVis
              is an open source alternative focused on collaboration and modern
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-white/10 bg-white/5 p-6">
                ...
                <ul className="ml-4 list-disc space-y-2 text-slate-300">
                  <li>Enterprise-ready professional tool</li>
                  <li>Excellent relationship visualization</li>
                  <li>Professional database modeling features</li>
                  <li>Paid service with support</li>
          ...
          <ComparisonDisclaimer competitorName="SqlDBM" />
        </div>
      </div>
    </div>
  );
