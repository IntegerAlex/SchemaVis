...
const competitor = getCompetitorById('dbdiagram')!;

export const metadata: Metadata = {
  title: 'dbdiagram.io vs SchemaVis: Honest Comparison for Database Visualization',
  description:
    'Compare dbdiagram.io and SchemaVis (alpha) for database visualization. dbdiagram.io uses a DSL approach, while SchemaVis focuses on open source collaboration.',
  openGraph: {
    title: 'dbdiagram.io vs SchemaVis: Honest Comparison',
    description:
      'Compare dbdiagram.io and SchemaVis for database visualization.',
    type: 'website',
    url: 'https://schemavis.gossorg.in/dbdiagram-vs-schemavis',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'dbdiagram.io vs SchemaVis: Honest Comparison',
    description: 'Compare dbdiagram.io and SchemaVis for database visualization.',
  },
};

export default function DbDiagramComparisonPage() {
  return (
        ...
        <div className="space-y-12">
          ...
          <header className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold">
                  dbdiagram.io vs SchemaVis: Honest Comparison
                </h1>
            ...
            <p className="text-lg text-slate-300">
              dbdiagram.io offers a unique DSL-based approach to database
              diagramming with a free tier. SchemaVis is building an open source
              alternative focused on real-time collaboration. This comparison
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-white/10 bg-white/5 p-6">
                <h3 className="mb-3 text-lg font-semibold text-white">
                  dbdiagram.io Approach
                </h3>
                <ul className="ml-4 list-disc space-y-2 text-slate-300">
                  <li>DSL-based (text definitions)</li>
                  <li>Easy version control integration</li>
                  <li>Good for simple to medium schemas</li>
                  <li>Free tier available</li>
                  <li>Can be limited with complex schemas</li>
                </ul>
              </div>
              <div className="rounded-lg border border-white/10 bg-white/5 p-6">
                <h3 className="mb-3 text-lg font-semibold text-white">
          ...
          <ComparisonDisclaimer competitorName="dbdiagram.io" />
        </div>
      </div>
    </div>
  );
