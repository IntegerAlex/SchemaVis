...
export const metadata: Metadata = {
  title: 'DBeaver vs SchemaVis: Honest Comparison for Database Visualization',
  description:
    'Compare DBeaver and SchemaVis (alpha) for database visualization. DBeaver is a comprehensive desktop tool, while SchemaVis is web-based and focused on visualization.',
  openGraph: {
    title: 'DBeaver vs SchemaVis: Honest Comparison',
    description:
      'Compare DBeaver and SchemaVis for database visualization.',
    type: 'website',
    url: 'https://schemavis.gossorg.in/dbeaver-vs-schemavis',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'DBeaver vs SchemaVis: Honest Comparison',
    description: 'Compare DBeaver and SchemaVis for database visualization.',
  },
};

export default function DBeaverComparisonPage() {
  return (
        ...
        <div className="space-y-12">
          ...
          <header className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold">
                  DBeaver vs SchemaVis: Honest Comparison
                </h1>
            ...
            <p className="text-lg text-slate-300">
              DBeaver is a comprehensive universal database tool with
              visualization capabilities, primarily a desktop application.
              SchemaVis is a web-based tool focused exclusively on database
              visualization. This comparison focuses on visualization
              capabilities only.
            </p>
          </header>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-white/10 bg-white/5 p-6">
                ...
                <ul className="ml-4 list-disc space-y-2 text-slate-300">
                  ...
                  <li>Universal database support</li>
                  <li>Complex but powerful interface</li>
                  <li>Fair visual quality</li>
              ...
              <div className="rounded-lg border border-white/10 bg-white/5 p-6">
                ...
                <ul className="ml-4 list-disc space-y-2 text-slate-300">
                  ...
                  <li>Focused on visualization only</li>
                  <li>Multi-database support</li>
                  <li>Simpler, focused interface</li>
                  <li>Good visual quality (improving)</li>
                  <li>Open source with planned collaboration</li>
                </ul>
              </div>
            </div>
          </section>
